...
\date{Last Revised: June 27, 2022}
\maketitle
...
the usual tools and conveniences. It is on DevBox where you spend most of your time working and
compiling your programs. It is on DevBox where you run source level debuggers.

The experimental system I call ``HackBox.'' It is not a full desktop system and instead is
...
``type 2'' hypervisor. These two types fundamentially conflict with each other. In fact, running
