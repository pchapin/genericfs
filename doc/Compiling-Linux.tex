...
\date{Last Revised: July 15, 2023}
\maketitle
...
operating systems class at Vermont Statee University. Some of the information it contains
...
5.15.0-76-generic.'' Note that the experimental kernel I am proposing to install (5.18.12) is
...
% TODO: What is the current (summer 2023) status of this situation? The paragraphs above were
...
\filename{/boot/config-5.15.0-76-generic} where 76 is the current (at the time of this writing)
